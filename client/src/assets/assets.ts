            ...
            <div class="flex pt-14">
                ...
                <aside class="fixed left-0 top-14 bottom-0 w-60 bg-yt px-3 py-4 overflow-y-auto hidden lg:block">
                    <nav class="space-y-2">
                        ...
                        <a target="_blank" href="https://www.youtube.com/@GreatStackDev?sub_confirmation=1" class="flex items-center gap-4 px-3 py-2 rounded-lg hover:bg-yt2"> <img src="https://greatstack.dev/favicon.ico" class="rounded-full size-7" /> Rutul </a>
                        ...
                        <article>
                            ...
                            <div class="flex gap-3 mt-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-400">Rutul YT Channel</p>
                        ...
                        <article>
                            ...
                            <div class="flex gap-3 mt-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-400">Frontend by Rutul</p>
