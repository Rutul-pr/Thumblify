        ...
        <footer className="flex flex-wrap justify-center md:justify-between overflow-hidden gap-10 md:gap-20 mt-40 py-6 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500">
            ...
            >
                <p className="max-w-72">
                    Built by Rutul as a sample college project, Thumblify showcases modern AI-assisted thumbnail creation with a clean and creator-friendly experience.
                </p>
                ...
                <p className="mt-3 text-center">&copy; {new Date().getFullYear()} <a href="https://prebuiltui.com?utm_source=pixels">Thumblify | Rutul</a></p>
            </motion.div>
        </footer>
    );
}